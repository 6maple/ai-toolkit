...
- No passive `brain_think` recall expansion into related project memories; the workspace-wide expansion applies only to model-initiated omitted-path `brain_glob` / `brain_grep`.
