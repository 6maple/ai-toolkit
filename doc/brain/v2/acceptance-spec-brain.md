...
**Then** presentation 将 injected block 明确标识为 prior starting context，而不是对 latest message 的新分析  
...
**Then** outer wrapper 将 injected block 表达为 prior starting context，并明确 reconcile/update/preserve relationship  
